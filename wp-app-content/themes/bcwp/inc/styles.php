...
//Dynamic styles
function bcwp_custom_styles($custom) {
	...
	if ( $primary_color != '#618EBA' ) {
		$custom .= "a, a:hover, .widget a:hover,.entry-meta a:hover,.entry-title a:hover, .main-navigation a:hover, .nav-next a:hover, .nav-previous a:hover, .social-navigation li a:hover { color:" . esc_attr($primary_color) . "}"."\n";
	...
	wp_add_inline_style( 'bcwp-style', $custom );	
}
add_action( 'wp_enqueue_scripts', 'bcwp_custom_styles' );